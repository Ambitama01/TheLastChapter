<html>
    ...
    <head>
        ...
        <title>Enjoy the Children's Books!!</title>
    ...
    <body>
        ...
        <div class="tagline">
            <h2>"You’re braver than you believe, stronger than you seem, and smarter than you think."– AA Milne</h2>
        </div>
            <div class="container">
                <div class="row text-center py-5">
                    <?php
                    $sql = "SELECT * from book_details where Genre='Children'";
                            ...
                            <div class="col-md-3 col-sm-6 my-3 my-md-0">
                                <form action="children.php" method="post">
                                    <div class="card shadow">
                                        <div>
                                            <a href="children_single.php?id=<?php echo $row['Book_id'];?>"><img src=<?php echo $row['Image'];?> alt="Image1" class="img-fluid card-img-top"></a>
                                        </div>
                                        <div class="card-body">
