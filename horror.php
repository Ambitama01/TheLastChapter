<html>
    ...
    <body>
        ...
        <div class="tagline">
            <h2>“Wendy? Darling? Light, of my life. I'm not gonna hurt ya. I'm just going to bash your brains in.”
― Stephen King, </h2>
        </div>
            <div class="container">
                <div class="row text-center py-5">
                    <?php
                    $sql = "SELECT * from book_details where Genre='Horror'";
                            ...
                            <div class="col-md-3 col-sm-6 my-3 my-md-0">
                                <form action="horror.php" method="post">
                                    <div class="card shadow">
                                        <div>
                                            <a href="horror_single.php?id=<?php echo $row['Book_id'];?>"><img src=<?php echo $row['Image'];?> alt="Image1" class="img-fluid card-img-top"></a>
                                        </div>
                                        <div class="card-body">
