<html>
    ...
    <body>
        ...
        <div class="title" id="title">
            <h1>Engage in Sci-Fi</h1>
        </div>
        <div class="tagline">
            <h2>“After all, a person is herself, and others. Relationships chisel the final shape of one's being. I am me, and you.”
— N.K. Jemisin </h2>
        </div>
            <div class="container">
                <div class="row text-center py-5">
                    <?php
                    $sql = "SELECT * from book_details where Genre='Sci-Fi'";
                    ...
                    if(!empty($result))
                    {
                        while ($row = mysqli_fetch_assoc($result)){
                            ...
                            <div class="col-md-3 col-sm-6 my-3 my-md-0">
                                <form action="sci-fi.php" method="post">
                                    <div class="card shadow">
                                        <div>
                                            <a href="sci-fi_single.php?id=<?php echo $row['Book_id'];?>"><img src=<?php echo $row['Image'];?> alt="Image1" class="img-fluid card-img-top"></a>
                                        </div>
                                        <div class="card-body">
