            ...
            $query=mysqli_query($conn,"SELECT customer_details.*,order_details.* from customer_details join order_details on customer_details.id=order_details.User_id
             ...
             if(mysqli_num_rows($query)>0){
                ...
                <p style=' text-align: center;
                    ...
                    padding-top: 100px;'>Hi, $name, your issue of $bookname expires today. Please click on the return book button on book issue page to return the book.Thank You. </p></div>";
                    }
                    if($mail->send()){
                        echo "Mail send";
                    }else{
