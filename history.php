<html>
    ...
    <body>
        ...
        <div class="tagline">
            <h2>"History is only the register of crimes and misfortunes." -Napoleon Bonaparte</h2>
        </div>
            <div class="container">
                <div class="row text-center py-5">
                    <?php
                    $sql = "SELECT * from book_details where Genre='History'";
                            ...
                            <div class="col-md-3 col-sm-6 my-3 my-md-0">
                                <form action="history.php" method="post">
                                    <div class="card shadow">
                                        <div>
                                            <a href="history_single.php?id=<?php echo $row['Book_id'];?>"><img src=<?php echo $row['Image'];?> alt="Image1" class="img-fluid card-img-top"></a>
                                        </div>
                                        <div class="card-body">
