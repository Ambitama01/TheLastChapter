<html>
    ...
    <body>
        ...
        <div class="title" id="title">
            <h1>Enter The World Of Mystery</h1>
        </div>
        <div class="tagline">
            <h2>“A mystery is only a fact in disguise”  ― A.J.West</h2>
        </div>
            <div class="container">
                <div class="row text-center py-5">
                    <?php
                    $sql = "SELECT * from book_details where Genre='Mystery'";
                    ...
                    if(!empty($result))
                    {
                        while ($row = mysqli_fetch_assoc($result)){
                            ...
                            <div class="col-md-3 col-sm-6 my-3 my-md-0">
                                <form action="mystery.php" method="post">
                                    <div class="card shadow">
                                        <div>
                                            <a href="single.php?id=<?php echo $row['Book_id'];?>"><img src=<?php echo $row['Image'];?> alt="Image1" class="img-fluid card-img-top"></a>
                                        </div>
                                        <div class="card-body">
