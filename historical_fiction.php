<html>
    ...
    <head>
        ...
        <title>Enjoy the mysterys!!</title>
    ...
    <body>
        ...
        <div class="title" id="title">
            <h1>Richness Of Historical Fiction</h1>
        </div>
        <div class="tagline">
            <h2>“The power of historical fiction for bad and for good can be immense in shaping consciousness of the past.” – Antony Beevor. </h2>
        </div>
            <div class="container">
                <div class="row text-center py-5">
                    <?php
                    $sql = "SELECT * from book_details where Genre='Historical Fiction'";
                            ...
                            <div class="col-md-3 col-sm-6 my-3 my-md-0">
                                <form action="historical_fiction.php" method="post">
                                    <div class="card shadow">
                                        <div>
                                            <a href="hfiction_single.php?id=<?php echo $row['Book_id'];?>"><img src=<?php echo $row['Image'];?> alt="Image1" class="img-fluid card-img-top"></a>
                                        </div>
                                        <div class="card-body">
