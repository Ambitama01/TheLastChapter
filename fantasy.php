<html>
    ...
    <body>
        ...
        <div class="title" id="title">
            <h1>Drown In Fantasy</h1>
        </div>
        <div class="tagline">
            <h2>“Stories of imagination tend to upset those without one.”― Terry Pratchett</h2>
        </div>
            <div class="container">
                <div class="row text-center py-5">
                    <?php
                    $sql = "SELECT * from book_details where Genre='Fantasy'";
                            ...
                            <div class="col-md-3 col-sm-6 my-3 my-md-0">
                                <form action="fantasy.php" method="post">
                                    <div class="card shadow">
                                        <div>
                                            <a href="fantasy_single.php?id=<?php echo $row['Book_id'];?>"><img src=<?php echo $row['Image'];?> alt="Image1" class="img-fluid card-img-top"></a>
                                        </div>
                                        <div class="card-body">
