<html>
    ...
    <head>
        ...
        <title>Enjoy the Non-Fiction!!</title>
    ...
    <body>
        ...
        <div class="tagline">
            <h2>“You know what I love about writing non-fiction? The story is already there. I just have to write it down.” ― Oliver Markus Malloy</h2>
        </div>
            <div class="container">
                <div class="row text-center py-5">
                    <?php
                    $sql = "SELECT * from book_details where Genre='Non-fiction'";
                    ...
                    if(!empty($result))
                    {
                        while ($row = mysqli_fetch_assoc($result)){
                            ...
                            <div class="col-md-3 col-sm-6 my-3 my-md-0">
                                <form action="non-fiction.php" method="post">
                                    <div class="card shadow">
                                        <div>
                                            <a href="non-fiction_single.php?id=<?php echo $row['Book_id'];?>"><img src=<?php echo $row['Image'];?> alt="Image1" class="img-fluid card-img-top"></a>
                                        </div>
                                        <div class="card-body">
