<html>
    ...
    <body>
        ...
        <div class="tagline">
            <h2>“That’s the thing about books. They let you travel without moving your feet.” – Jhumpa Lahiri </h2>
        </div>
            <div class="container">
                <div class="row text-center py-5">
                    <?php
                    $sql = "SELECT * from book_details where Genre='Action'";
                            ...
                            <div class="col-md-3 col-sm-6 my-3 my-md-0">
                                <form action="action.php" method="post">
                                    <div class="card shadow">
                                        <div>
                                            <a href="action_single.php?id=<?php echo $row['Book_id'];?>"><img src=<?php echo $row['Image'];?> alt="Image1" class="img-fluid card-img-top"></a>
                                        </div>
                                        <div class="card-body">
