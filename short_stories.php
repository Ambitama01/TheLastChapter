<html>
    ...
    <body>
        ...
        <div class="tagline">
            <h2>“A short story is a love affair, a novel is a marriage. A short story is a photograph; a novel is a film.”
― Lorrie Moore</h2>
        </div>
            <div class="container">
                <div class="row text-center py-5">
                    <?php
                    $sql = "SELECT * from book_details where Genre='Short Stories'";
                    ...
                    if(!empty($result))
                    {
                        while ($row = mysqli_fetch_assoc($result)){
                            ...
                            <div class="col-md-3 col-sm-6 my-3 my-md-0">
                                <form action="short_stories.php" method="post">
                                    <div class="card shadow">
                                        <div>
                                            <a href="short_single.php?id=<?php echo $row['Book_id'];?>"><img src=<?php echo $row['Image'];?> alt="Image1" class="img-fluid card-img-top"></a>
                                        </div>
                                        <div class="card-body">
