<html>
    ...
    <head>
        ...
        <title>Enjoy the Literary Fiction!!</title>
    ...
    <body>
        ...
        <div class="title" id="title">
            <h1>Beauty of Literary Fiction</h1>
        </div>
        <div class="tagline">
            <h2>“All we have to decide is what to do with the time that is given us.”- J.R.R. Tolkein </h2>
        </div>
            <div class="container">
                <div class="row text-center py-5">
                    <?php
                    $sql = "SELECT * from book_details where Genre='Literary Fiction '";
                    ...
                    if(!empty($result))
                    {
                        while ($row = mysqli_fetch_assoc($result)){
                            ...
                            <div class="col-md-3 col-sm-6 my-3 my-md-0">
                                <form action="literary_fiction.php" method="post">
                                    <div class="card shadow">
                                        <div>
                                            <a href="lfiction_single.php?id=<?php echo $row['Book_id'];?>"><img src=<?php echo $row['Image'];?> alt="Image1" class="img-fluid card-img-top"></a>
                                        </div>
                                        <div class="card-body">
