<html>
    ...
    <body>
        ...
        <div class="title" id="title">
            <h1>Bibliography And Autobiography</h1>
        </div>
        <div class="tagline">
            <h2>“Each source that I read, I would look through the bibliography and the footnotes, and use that as a map for the next thing I would read.” -Alexander Chee</h2>
        </div>
            <div class="container">
                <div class="row text-center py-5">
                    <?php
                    $sql = "SELECT * from book_details where Genre='Bibliography'";
                            ...
                            <div class="col-md-3 col-sm-6 my-3 my-md-0">
                                <form action="bibliography.php" method="post">
                                    <div class="card shadow">
                                        <div>
                                            <a href="bibliography_single.php?id=<?php echo $row['Book_id'];?>"><img src=<?php echo $row['Image'];?> alt="Image1" class="img-fluid card-img-top"></a>
                                        </div>
                                        <div class="card-body">
