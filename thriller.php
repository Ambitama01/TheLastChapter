<html>
    ...
    <body>
        ...
        <div class="title" id="title">
            <h1>Thrilling Thrillers</h1>
        </div>
        <div class="tagline">
            <h2>“It will be a killer, and a chiller, and a thriller, when I get the gorilla in Manila.” -Muhammad Ali</h2>
        </div>
            <div class="container">
                <div class="row text-center py-5">
                    <?php
                    $sql = "SELECT * from book_details where Genre='Thriller'";
                    ...
                    if(!empty($result))
                    {
                        while ($row = mysqli_fetch_assoc($result)){
                            ...
                            <div class="col-md-3 col-sm-6 my-3 my-md-0">
                                <form action="thriller.php" method="post">
                                    <div class="card shadow">
                                        <div>
                                            <a href="thriller_single.php?id=<?php echo $row['Book_id'];?>"><img src=<?php echo $row['Image'];?> alt="Image1" class="img-fluid card-img-top"></a>
                                        </div>
                                        <div class="card-body">
